...
<a href="https://github.com/lambwf/Countries-that-reached-peak-ghg-emissions/" target="_blank">Source Code</a>
</div>
</div>
<div class='grid'>
...
<!-- <a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/map.png'>png</a> |  -->
<!-- <a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/map.pdf'>pdf</a> |  -->
<!-- <a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/map.svg'>svg</a> -->
<!-- </div> -->
</div>
...
for (file in filenames) {
  ...
  link_data <- ifelse(grepl("trend",country),
                      "<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-emissions/main/results/Countries-peak-emissions-totals.xlsx'>data</a>",
                      "<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-emissions/main/results/Countries-peak-emissions-trend.xlsx'>data</a>")
  
  link_png <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/countries/", country, ".png'>png</a>")
  
  link_pdf <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/countries/", country, ".pdf'>pdf</a>")
  
  link_svg <- paste0("<a target='_blank' href='https://raw.githubusercontent.com/lambwf/Countries-that-reached-peak-ghg-emissions/main/results/countries/", country, ".svg'>svg</a>")
